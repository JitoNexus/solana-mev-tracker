...
function initializeWallet() {
    ...
    const walletAddress = tgWebApp.initDataUnsafe?.start_param;

    if (walletAddress) {
        document.getElementById("wallet-address").textContent = `Address: ${walletAddress}`;
    } else {
        document.getElementById("wallet-address").textContent = "Please get your wallet from the Telegram bot first.";
    }
}
